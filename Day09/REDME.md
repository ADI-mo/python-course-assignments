...
📁 Project Structure
analyzer.py: The main unified script that handles data fetching (GitHub API), pedagogical analysis, and visualization.

course_data_results.xlsx: Detailed raw data exported to Excel for further academic or administrative analysis.

final_course_report.png: The automated visual dashboard generated by the script (saved locally to your Downloads folder).

README.md: Project documentation featuring a static dashboard example to demonstrate the system's output.
