...
late_plot.plot(kind='bar', stacked=True, ax=ax2, color=["#1def75", '#e74c3c'])
design_ax(ax2, "Lateness Distribution", "Students")

# גרף 4: רמת קושי (תגובות)
...
# תיבת סיכום (Row 4 - תופסת את כל הרוחב)
